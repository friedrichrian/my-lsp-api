...
use App\Http\Controllers\Apl02SimpleImportController;
...
Route::middleware(['auth:sanctum', 'admin'])->group(function () {
    ...
    Route::post('/apl02/import', [Apl02SimpleImportController::class, 'import']);
    Route::get('/apl02/{id}', [Apl02SimpleImportController::class, 'show']);
});
